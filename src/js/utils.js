...
export function setDynamicCss(PAGE_WIDTH, PAGE_HEIGHT, MAX_X, MAX_Y, PAGE_LEFT, PAGE_TOP) {
...
export function setDocumentTitle(PAGE_WIDTH, PAGE_HEIGHT, SIDE_LENGTH, PAGE_LEFT, PAGE_RIGHT, PAGE_TOP, PAGE_BOTTOM, FILE_NAME_MIDDLE, FILE_NAME_POSTFIX) {
...
export function getSvg(options) {
    const { id: ID, // : string;
