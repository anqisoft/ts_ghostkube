 ...
 * src\cubeCompute6_step3_patch.ts v0.0.1
...
cls && deno lint %pwd%\cubeCompute6_step3_patch.ts & deno fmt %pwd%\cubeCompute6_step3_patch.ts

deno run --v8-flags=--max-old-space-size=20480 -A P:\anqi\Desktop\tech\ts\projects\203_ts_ghostkube\src\cubeCompute6_step3_patch.ts

deno run --v8-flags=--max-old-space-size=20480 -A %pwd%\cubeCompute6_step3_patch.ts

cls && deno run --v8-flags=--max-old-space-size=20480 -A %pwd%\cubeCompute6_step3_patch.ts
*/
