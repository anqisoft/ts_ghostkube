 ...
 * src\cubeCompute5_step4.ts v0.0.1
...
const GOAL_FILE_TOP_PATH = './step4/';
...
copySync('log.txt', 'log_step4.txt', { overwrite: true });
...
cls && deno lint %pwd%\cubeCompute5_step4.ts && deno fmt %pwd%\cubeCompute5_step4.ts

deno run --v8-flags=--max-old-space-size=20480 -A P:\anqi\Desktop\tech\ts\projects\203_ts_ghostkube\src\cubeCompute5_step4.ts

deno run --v8-flags=--max-old-space-size=20480 -A %pwd%\cubeCompute5_step4.ts

cls && deno run --v8-flags=--max-old-space-size=20480 -A %pwd%\cubeCompute5_step4.ts
*/
