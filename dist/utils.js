...
function getSvg(options) {
    const { id: ID, setName: SET_NAME, setNo: SET_NO, cubeNo: CUBE_NO, sideLength: SIDE_LENGTH, circleRadius: CIRCLE_RADIUS, textOffset: TEXT_OFFSET, thickness: THICKNESS, innerLineCss: INNER_LINE_CSS, outerLineCss: OUTER_LINE_CSS, cutterLineCss: CUT_LINE_CSS, faceTextCss: FACE_TEXT_CSS, setTextCss: SET_TEXT_CSS } = options;
    ...
    ACT_CELLS.forEach((cell)=>{
        const { layerIndex: LAYER_INDEX, feature: FEATURE, sixFace: SIX_FACE, faceDirection: FACE_DIRECTION, twelveEdge: TWELVE_EDGE, rowIndex: ROW_INDEX, colIndex: COL_INDEX } = cell;
